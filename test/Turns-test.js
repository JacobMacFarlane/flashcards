...
describe('Turns', () => {
    ...
    it('Should also hold the currrent Card in play', () => {
        const card = new Card(1, 'What is Jacobs fav animal', ['Roadrunner', 'Tiger', 'Monkey'], 'Monkey')
    ...
    it('Should be able to determine if the users guess is not correct', () => {
        let card = new Card(1, 'What is Jacobs fav animal', ['Roadrunner', 'Tiger', 'Monkey'], 'Monkey')
        const turns = new Turns('Roadrunner', card)
